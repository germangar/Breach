...
typedef struct
{
	...
	void ( *Refresh )( unsigned int time, int clientState, int serverState, int keydest, qboolean demoplaying, qboolean backGround );
	void ( *DrawConnectScreen )( char *serverName, char *rejectmessage, int downloadType, char *downloadfilename, float downloadPercent, int downloadSpeed, int connectCount, qboolean demoplaying );
	...
	struct menuitem_public_s *( *InitItemCheckBox )( const char *windowname, const char *itemname, int x, int y, int align, void *Update, void *Apply, qboolean alwaysApply, char *targetString );
	struct menuitem_public_s *( *InitItemSpinner )( const char *windowname, const char *itemname, int x, int y, int align, struct mufont_s *font, char *spinnerNames, void *Update, void *Apply, qboolean alwaysApply, char *targetString );
	struct menuitem_public_s *( *InitItemSlider )( const char *windowname, const char *itemname, int x, int y, int align, int min, int max, float stepsize, void *Update, void *Apply, qboolean alwaysApply, char *targetString );
	struct menuitem_public_s *( *InitItemListbox )( const char *windowname, const char *itemname, int x, int y, int align, struct mufont_s *font, char *namesList, void *Update, void *Apply, qboolean alwaysApply, void *Action, char *targetString );
